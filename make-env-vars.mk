...
define windows_config
	...
	LINKER_FLAGS:=-lutils -lnetworking -ltgui-s \
...
define linux_config
	...
	LIBS_SEARCH_PATHS:=./ ./lib \
						$${LIB_DIRECTORIES}
	LINKER_FLAGS:=-lutils -lnetworking -ltgui \
	...
	PROJECT_FINAL_FLAGS:=-Wl,--whole-archive,-Bstatic -L $${LIBRARY_PREFIX}/box2d-3.1.0/src -lbox2d -Wl,-Bdynamic,--no-whole-archive -Wl,--export-dynamic
endef
